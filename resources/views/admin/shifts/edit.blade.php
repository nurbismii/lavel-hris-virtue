...
@section('title', __('Edit Master Shift'))
...
<div class="container-fluid">
    <div class="page-inner">
        <div class="d-flex justify-content-between align-items-center pt-2 pb-4">
            <div>
                <h4 class="fw-bold mb-1">{{ __('Edit Master Shift') }}</h4>
                <small class="text-muted">{{ __('Perbarui jam kerja yang dipakai pada pengaturan shift harian.') }}</small>
            </div>
