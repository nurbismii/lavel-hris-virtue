...
@section('title', __('Edit Data Karyawan'))
    ...
    <div class="page-inner ui-page">
        <div class="ui-page-header employee-edit-header">
            <div class="employee-edit-header__identity">
                ...
                <div>
                    <div class="employee-edit-header__eyebrow">{{ __('Edit Data Karyawan') }}</div>
        ...
        <div class="alert ui-alert ui-alert--warning employee-validation-alert">
            ...
            <div>
                <div class="employee-validation-alert__title">{{ __('Perubahan belum bisa disimpan.') }}</div>
                        ...
                        <div class="ui-panel__body">
                            ...
                            <div class="tab-content">
                                <div class="tab-pane fade {{ $showViolationTab ? '' : 'show active' }}" id="profil-pane" role="tabpanel" aria-labelledby="profil-tab">
                                    <div class="employee-edit-section">
                                        <div class="employee-edit-section__card">
                                            ...
                                            <div class="employee-edit-section__caption">{{ __('Informasi personal utama yang dipakai pada profil dan akses akun.') }}</div>
                                            <div class="row g-3">
                                                <div class="col-md-4">
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <select name="jenis_kelamin" class="form-select form-control">
                                                        ...
                                                        <option value="L" {{ old('jenis_kelamin', $employee->jenis_kelamin) == 'L' ? 'selected' : '' }}>{{ __('Laki-laki') }}</option>
                                                        <option value="P" {{ old('jenis_kelamin', $employee->jenis_kelamin) == 'P' ? 'selected' : '' }}>{{ __('Perempuan') }}</option>
                                                    </select>
                                                </div>
                                                <div class="col-md-4">
                                                ...
                                                <div class="col-md-4">
                                                    <label class="form-label">{{ __('Tanggal Menikah') }}</label>
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <select name="agama" class="form-select form-control">
                                                        ...
                                                        <option value="ISLAM 伊斯兰教" {{ $employee->agama == 'ISLAM 伊斯兰教' ? 'selected' : '' }}>{{ __('ISLAM 伊斯兰教') }}</option>
                                                        <option value="KRISTEN PROTESTAN 基督教新教" {{ $employee->agama == 'KRISTEN PROTESTAN 基督教新教' ? 'selected' : '' }}>{{ __('KRISTEN PROTESTAN 基督教新教') }}</option>
                                                        <option value="KRISTEN KATHOLIK 天主教徒" {{ $employee->agama == 'KRISTEN KATHOLIK 天主教徒' ? 'selected' : '' }}>{{ __('KRISTEN KATHOLIK 天主教徒') }}</option>
                                                        <option value="HINDU 印度教" {{ $employee->agama == 'HINDU 印度教' ? 'selected' : '' }}>{{ __('HINDU 印度教') }}</option>
                                                        <option value="BUDHA 佛教" {{ $employee->agama == 'BUDHA 佛教' ? 'selected' : '' }}>{{ __('BUDHA 佛教') }}</option>
                                                        <option value="KHONGHUCU 儒家" {{ $employee->agama == 'KHONGHUCU 儒家' ? 'selected' : '' }}>{{ __('KHONGHUCU 儒家') }}</option>
                                                    </select>
                                                </div>
                                                <div class="col-md-4">
                                                    <label class="form-label">{{ __('Status Perkawinan') }}</label>
                                                    <select name="status_perkawinan" id="status_perkawinan" class="form-select form-control">
                                                        <option value="">{{ __('Pilih Status') }}</option>
                                                        <option value="Belum Kawin" {{ old('status_perkawinan', $employee->status_perkawinan) == 'Belum Kawin' ? 'selected' : '' }}>{{ __('Belum Kawin') }}</option>
                                                        <option value="Kawin" {{ old('status_perkawinan', $employee->status_perkawinan) == 'Kawin' ? 'selected' : '' }}>{{ __('Kawin') }}</option>
                                                        <option value="Cerai" {{ old('status_perkawinan', $employee->status_perkawinan) == 'Cerai' ? 'selected' : '' }}>{{ __('Cerai') }}</option>
                                                    </select>
                                                </div>
                                                <div class="col-md-4">
                                                    <label class="form-label">{{ __('No. Telp') }}</label>
                                    ...
                                    <div class="employee-edit-section">
                                        <div class="employee-edit-section__card">
                                            <div class="employee-edit-section__title">{{ __('Pekerjaan dan Organisasi') }}</div>
                                            <div class="employee-edit-section__caption">{{ __('Data penempatan kerja, struktur organisasi, dan status aktif karyawan.') }}</div>
                                            <div class="row g-3">
                                                <div class="col-md-4">
                                                    <label class="form-label">{{ __('No SK PKWTT') }}</label>
                                                ...
                                                <div class="col-md-4">
                                                    <label class="form-label">{{ __('Status Kontrak') }}</label>
                                                    <select name="status_karyawan" class="form-select form-control">
                                                        <option value="">{{ __('-- Pilih --') }}</option>
                                                        <option value="PKWTT 固定工" {{ $employee->status_karyawan == 'PKWTT 固定工' ? 'selected' : '' }}>{{ __('PKWTT 固定工') }}</option>
                                                        <option value="PKWT 合同工" {{ $employee->status_karyawan == 'PKWT 合同工' ? 'selected' : '' }}>{{ __('PKWT 合同工') }}</option>
                                                    </select>
                                                </div>
                                                <div class="col-md-4">
                                                ...
                                                <div class="col-md-4">
                                                    <label class="form-label">{{ __('Kode Area Kerja') }}</label>
                                                ...
                                                <div class="col-md-4">
                                                    <label class="form-label">{{ __('Status Karyawan') }}</label>
                                                    <select name="status_resign" id="status_resign" class="form-select form-control">
                                                        <option value="">{{ __('-- Pilih Status --') }}</option>
                                                        <option value="AKTIF" {{ old('status_resign', $employee->status_resign) == 'AKTIF' ? 'selected' : '' }}>{{ __('Aktif') }}</option>
                                                        <option value="RESIGN SESUAI PROSEDUR" {{ old('status_resign', $employee->status_resign) == 'RESIGN SESUAI PROSEDUR' ? 'selected' : '' }}>{{ __('Resign Sesuai Prosedur') }}</option>
                                                        <option value="RESIGN TIDAK SESUAI PROSEDUR" {{ old('status_resign', $employee->status_resign) == 'RESIGN TIDAK SESUAI PROSEDUR' ? 'selected' : '' }}>{{ __('Resign Tidak Sesuai Prosedur') }}</option>
                                                        <option value="RESIGN TIDAK SESUAI PROSEDUR-PENGAJUAN" {{ old('status_resign', $employee->status_resign) == 'RESIGN TIDAK SESUAI PROSEDUR-PENGAJUAN' ? 'selected' : '' }}>{{ __('Resign Tidak Sesuai Prosedur - Pengajuan') }}</option>
                                                        <option value="RESIGN TIDAK SESUAI PROSEDUR-KABUR" {{ old('status_resign', $employee->status_resign) == 'RESIGN TIDAK SESUAI PROSEDUR-KABUR' ? 'selected' : '' }}>{{ __('Resign Tidak Sesuai Prosedur - Kabur') }}</option>
                                                        <option value="RESIGN TIDAK SESUAI PROSEDUR-PAYROLL" {{ old('status_resign', $employee->status_resign) == 'RESIGN TIDAK SESUAI PROSEDUR-PAYROLL' ? 'selected' : '' }}>{{ __('Resign Tidak Sesuai Prosedur - Payroll') }}</option>
                                                        <option value="PB RESIGN" {{ old('status_resign', $employee->status_resign) == 'PB RESIGN' ? 'selected' : '' }}>{{ __('PB Resign') }}</option>
                                                        <option value="PUTUS KONTRAK" {{ old('status_resign', $employee->status_resign) == 'PUTUS KONTRAK' ? 'selected' : '' }}>{{ __('Putus Kontrak') }}</option>
                                                        <option value="PHK" {{ old('status_resign', $employee->status_resign) == 'PHK' ? 'selected' : '' }}>{{ __('PHK') }}</option>
                                                        <option value="PHK PENSIUN" {{ old('status_resign', $employee->status_resign) == 'PHK PENSIUN' ? 'selected' : '' }}>{{ __('PHK Pensiun') }}</option>
                                                        <option value="PHK PENSIUN DINI" {{ old('status_resign', $employee->status_resign) == 'PHK PENSIUN DINI' ? 'selected' : '' }}>{{ __('PHK Pensiun Dini') }}</option>
                                                        <option value="PHK PIDANA" {{ old('status_resign', $employee->status_resign) == 'PHK PIDANA' ? 'selected' : '' }}>{{ __('PHK Pidana') }}</option>
                                                        <option value="PHK MENINGGAL DUNIA" {{ old('status_resign', $employee->status_resign) == 'PHK MENINGGAL DUNIA' ? 'selected' : '' }}>{{ __('PHK Meninggal Dunia') }}</option>
                                                    </select>
                                                </div>
                                                <div class="col-md-4">
                                                    <label class="form-label">{{ __('Tanggal Resign') }}</label>
                                                ...
                                                <div class="col-md-4">
                                                    <label class="form-label">{{ __('Kategori Keluar') }}</label>
                                                ...
                                                <div class="col-md-12">
                                                    <label class="form-label">{{ __('Alasan Resign') }}</label>
                                    ...
                                    <div class="employee-edit-section">
                                        <div class="employee-edit-section__card">
                                            <div class="employee-edit-section__title">{{ __('Operasional') }}</div>
                                            <div class="employee-edit-section__caption">{{ __('Data operasional karyawan dan informasi terkait.') }}</div>
                                            <div class="row g-3">
                                                <div class="col-md-6">
                                                    <label class="form-label">{{ __('Mulai Berlaku Pola Kerja') }}</label>
                                                ...
                                                <div class="col-md-6">
                                                    <label class="form-label">{{ __('Jam Kerja') }}</label>
                                    ...
                                    <div class="employee-edit-section">
                                        <div class="employee-edit-section__card">
                                            <div class="employee-edit-section__title">{{ __('Administrasi') }}</div>
                                            <div class="employee-edit-section__caption">{{ __('Nomor identitas administrasi dan kepesertaan jaminan sosial.') }}</div>
                                            <div class="row g-3">
                                                <div class="col-md-4">
                                                ...
                                                <div class="col-md-4">
                                                    <label class="form-label">{{ __('No Rekening') }}</label>
                                    ...
                                    <div class="employee-edit-section">
                                        <div class="employee-edit-section__card">
                                            <div class="employee-edit-section__title">{{ __('Pendidikan') }}</div>
                                            <div class="employee-edit-section__caption">{{ __('Riwayat pendidikan terakhir yang tersimpan pada master data karyawan.') }}</div>
                                            <div class="row g-3">
                                                <div class="col-md-6">
                                                    <label class="form-label">{{ __('Nama Instansi Pendidikan') }}</label>
                                ...
                                <div class="tab-pane fade" id="alamat-pane" role="tabpanel" aria-labelledby="alamat-tab">
                                    <div class="employee-edit-section">
                                        <div class="employee-edit-section__card">
                                            <div class="employee-edit-section__title">{{ __('Wilayah Administratif') }}</div>
                                            <div class="employee-edit-section__caption">{{ __('Pilih wilayah bertingkat untuk data alamat KTP dan domisili.') }}</div>
                                            <div class="row g-3">
                                                <div class="col-md-3">
                                    ...
                                    <div class="employee-edit-section">
                                        <div class="employee-edit-section__card">
                                            <div class="employee-edit-section__title">{{ __('Alamat Lengkap') }}</div>
                                            <div class="employee-edit-section__caption">{{ __('Simpan alamat KTP dan domisili dengan format yang jelas dan mudah diverifikasi.') }}</div>
                                            <div class="row g-3">
                                                <div class="col-md-4">
                                ...
                                <div class="tab-pane fade" id="dokumen-pane" role="tabpanel" aria-labelledby="dokumen-tab">
                                    <div class="employee-edit-section">
                                        <div class="employee-edit-section__card">
                                            <div class="employee-edit-section__title">{{ __('Foto Referensi Wajah') }}</div>
                                            <div class="employee-edit-section__caption">{{ __('Dipakai untuk validasi presensi berbasis foto. Gunakan foto wajah lurus ke kamera.') }}</div>
                                                    ...
                                                    <div class="employee-document-row__grid">
                                                        ...
                                                        <div>
                                                            <div class="employee-document-row__header">
                                                                <div>
                                                                    <div class="employee-document-row__title">{{ __('Foto Referensi Wajah') }}</div>
                                                            ...
                                                            <div class="employee-document-row__upload">
                                                                <label class="form-label">{{ __('Ganti Foto Referensi') }}</label>
                                                                ...
                                                                <div class="employee-document-input__help">
                                                                    {{ __('Upload baru akan menimpa file lama dan memperbarui data karyawan.') }}
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                    ...
                                    <div class="employee-edit-section">
                                        <div class="employee-edit-section__card">
                                            <div class="employee-edit-section__title">{{ __('Dokumen Legal Karyawan') }}</div>
                                            <div class="employee-edit-section__caption">{{ __('Setiap upload baru akan menimpa file lama untuk jenis dokumen yang sama, lalu memperbarui path file di database.') }}</div>
                                            <div class="employee-document-list">
                ...
                <div class="col-xl-4">
                    <div class="employee-action-card d-flex flex-column gap-4">
                        ...
                        <section class="ui-panel employee-save-card">
                            <div class="ui-panel__body">
                                <div class="employee-edit-section__title">{{ __('Aksi') }}</div>
                                <div class="employee-edit-section__caption">{{ __('Simpan perubahan setelah seluruh data dan dokumen diperiksa kembali.') }}</div>
    ...
    <div class="modal-dialog modal-xl modal-dialog-centered modal-dialog-scrollable">
        <div class="modal-content">
            <div class="modal-header">
                <div>
                    <h5 class="modal-title" id="employeeDocumentPreviewModalLabel">{{ __('Preview Dokumen') }}</h5>
            ...
            <div class="modal-body p-0">
                ...
                <div class="employee-document-modal__surface d-none" id="employeeDocumentPreviewPdfWrap">
                    <iframe id="employeeDocumentPreviewPdf" src="" title="{{ __('Preview PDF') }}"></iframe>
                </div>
            </div>
