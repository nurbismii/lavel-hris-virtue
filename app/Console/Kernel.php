...
class Kernel extends ConsoleKernel
{
    ...
    protected function schedule(Schedule $schedule)
    {
        ...
        $schedule->command('roster:generate-schedules --years-ahead=2 --limit=5000')->dailyAt('00:30')->withoutOverlapping();
        $schedule->command('roster:send-schedule-reminders --limit=1000')->dailyAt('07:30')->withoutOverlapping();
